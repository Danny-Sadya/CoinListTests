...
class Scraper:
    ...
    def run(self):
        try:
            ...
            self.driver.execute_script('document.getElementsByClassName("g-recaptcha-response")[1].innerHTML = "{}";'.format(answer))
            self.driver.execute_script('document.getElementsByClassName("g-recaptcha-response")[0].innerHTML = "{}";'.format(answer))
